...
<%@ page import="wangyuandong.model.User" %>
		<%@ page import="wangyuandong.model.Order" %>
		<%@ page import="wangyuandong.model.Payment" %>
		<section id="z`z`">
		<div class="container">
			<div class="step-one">
				...
				<div class="total_area">
					...
					%>
						<ul>
							...
							<li>Password :<span><%=u.getPasswords()%></span></li>
							<li>Email :<span><%=u.getEmails()%></span></li>
								...
								<c:forEach var="o" items="${orderList}">
									<tr>
										...
										<td><p>${o.firstName} ${o.lastName}</p>
											<p>${o.address1}</p>
											<p>${o.address2}</p>
											<p>${o.city},${o.state},${o.country-postalCode}</p>
											<p>${o.phone}</p>
										</td>
										<td class="cart_total">
											<%
